    ...
    try {
      ...
      devis.prestations.forEach((prestation) => {
        ...
        if (alternate) {
          ...
          doc.rect(margin, y - 3, contentWidth, TABLE_CONFIG.body.rowHeight, 'F');
        }
        ...
        doc.text(formatCurrency(prestation.prixUnitaireHT), margin + 130, y + 1);
